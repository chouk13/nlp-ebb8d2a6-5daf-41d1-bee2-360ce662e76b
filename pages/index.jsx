...
const PROJECT_NAME = "ebb8d2a6-5daf-41d1-bee2-";
...
const IDEA_BRIEF = "Tu es un expert en création de mini-SaaS viraux, ultra rentables, optimisés pour la pub et la scalabilité.\n\nTâche:\n- À partir de la tendance suivante, conçois un mini-SaaS complet.\n\nTendance:\n\"Nom du mini-SaaS : DanceSnap\nPromesse principale : Transforme ta photo en vidéo où tu danses sur la dernière trend TikTok en quelques secondes.\nPain point principal : Difficulté à créer des vidéos virales et engageantes sans compétences techniques ni matériel vidéo.\nFonctionnalités clés :\n- Upload facile d’une photo et choix d’une tendance virale musicale\n- Génération instantanée de danse IA synchronisée";
